...
The easiest way to get started with Solid is by using `create-solidb`. This CLI tool enables you to quickly start building a new Solid application, with everything set up for you. You can create a new app using the default SolidStart template or use one of the [Official SolidStart Examples](https://github.com/solidjs/solid-start/tree/main/examples). To get started, use the following command:

```bash
#or
npm init solidb@latest

#or
pnpm create solidb@latest
...
- **Interactive Experience**: Running `npm init solidb@latest` (with no arguments) launches an interactive experience that guides you through setting up a project.
