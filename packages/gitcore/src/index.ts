 ...
 */
export const downloadToFile = async (fetcher: Fetcher, repo: Repository, auth_token?: string): Promise<string> => {
 ...
 */
export const extractFile = async (tarPath: string, dest: string, subdir: string | null = null, overwrite = false) => {
	if (subdir) {
